...
const INITIAL_RATES: Record<string, Record<ScenarioKey, number>> = {
  ...
  SEI:  { conservador: 0.02, moderado: 0.06, base: 0.10, favorable: 0.14, muy_favorable: 0.18, optimista: 0.23 },
...
const MAX_PRICE_MULTIPLIERS: Record<string, ScenarioMultiplierMap> = {
  ...
  SEI:  { conservador: 3, moderado: 5, base: 7,  favorable: 10, muy_favorable: 13, optimista: 17, default: 7  },
