...
beforeEach(() => {
  window.cryptoControl = {
    ...
    portfolio: {
      ...
      getLiveSnapshot: async () => ({ ok: true as const, data: null }),
    },
    diagnostics: {
    ...
    perspectives: {
      ...
      getConsolidatedSnapshot: async (): Promise<any> => ({ ok: true as const, data: {} }),      getAnalystForecasts: async (): Promise<any> => ({ ok: true as const, data: [] }),
    },
    smartBuy: {
