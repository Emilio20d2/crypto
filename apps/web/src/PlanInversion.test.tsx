...
beforeEach(() => {
  ...
  (window as any).cryptoControl = {
    ...
    perspectives: {
      ...
      getProjection: async () => ({ ok: true as const, data: { snapshot: { snapshotId: "snap-mock", generatedAt: 0, planId: "plan-1", planName: "Plan mock", historicalCapitalEur: 0, historicalSalesEur: 0, positionCount: 0, treasury: { cashEur: 0, eurcEur: 0, eurcAvailableEur: 0, fiscalReserveEur: 0, totalLiquidityEur: 0 }, dataQuality: { overallScore: 1, missingPrices: [], missingCosts: [], staleData: [], notes: [] }, positions: {}, fiscalVersion: "es-2024", strategyVersion: "v1" }, scenarios: [], comparison: [], horizonYears: 10, generatedAt: 0 } }),
    },
    smartBuy: {
