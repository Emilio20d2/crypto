...
| FASE 1 - Migracion productiva completa a Perspectivas V5 | IN_PROGRESS | FASE 0 VALIDATED | Demostrar V5 productivo, eliminar grafo V4, DTO V5 nativo | `apps/desktop/src/main.ts`, `packages/portfolio/src/index.ts`, `packages/portfolio/src/perspectives-v5/*`, tests productivos | Pendiente | Grep V4 cero, productive-route tests, typecheck | Pendiente | `apps/desktop/src/main.ts` todavia invoca `runPerspectivesSimulation` en la base del PR |
